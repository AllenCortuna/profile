    ...
    <>
      ...
      <span className="flex flex-col justify-center content-top gap-5 mt-40">
        ...
        >
          ...
          <p
            className="text-gray-200 font-[400] w-[16rem] space md:text-md text-sm mt-3 md:w-[22rem] mx-auto pt-5 md:pt-10"
        ...
        <button
          className="mt-10 border border-2 rounded-full p-4 text-center bg-none text-white w-[10rem] mx-auto space font-[700] flex flex-row justify-center content-center gap-3 hover:bg-zinc-200 hover:text-black transition-all ease-linear duration-400"
